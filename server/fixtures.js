...
if (Fruit_Vegetables.find().count() === 0) {
    Fruit_Vegetables.insert({
        _id: "fruit_vegetables_001",
        name: "Apples",
        weight: "1 kg",
        type: "Fruit",
